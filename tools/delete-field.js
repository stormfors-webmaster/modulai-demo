...
function log(...a) { console.log("[delete-field]", ...a); }
function warn(...a) { console.warn("[delete-field:warn]", ...a); }
function fail(msg, e) {
...
async function main() {
  try {
    ...
    if (!field) {
      log(`✅ Field '${FIELD_TO_DELETE}' not found - may have already been deleted.`);
      return;
    }
